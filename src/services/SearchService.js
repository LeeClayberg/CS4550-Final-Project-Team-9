...
const search = (content, page) => {
    return fetch("/search/?api_key=609b66edd3d828492cadbe8b2cc825f2d712aaef&sortBy=name:asc" +
...
const findRelatedIssues = (issue) => {
    ...
    return fetch("/issues/?api_key=609b66edd3d828492cadbe8b2cc825f2d712aaef" +
          "&format=json&limit=5&filter=volume:" + issue.volume.id +
          ",cover_date:" + begin.toISOString().substring(0, 10) + "|" + end.toISOString().substring(0, 10))
        .then(response => response.json())}
